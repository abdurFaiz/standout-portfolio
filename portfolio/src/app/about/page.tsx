...
export default function about() {
    ...
    return (
        <section className="w-full">
            <div className="min-h-screen bg-background-custom max-w-[1520px] mx-auto w-full">
                <Navbar />
                ...
                {/* About Section */}
                <section className="relative z-10 bg-background-custom min-h-screen py-20 md:py-40">
                    <div className="flex flex-col-reverse md:flex-row items-start justify-between px-4 md:px-8 w-full gap-10">
                        {/* Text Section */}
                        <div className="w-full md:w-1/2 max-w-2xl flex flex-col gap-5">
                            <h2 className="font-TiemposHeadlineLight text-4xl md:text-6xl text-neutral-black-custom font-medium leading-tight">
                                A bit about me
                            </h2>
                            ...
                            <h2 className="font-TiemposHeadlineLight text-4xl text-neutral-black-custom font-medium leading-tight">
                                What I do
                            </h2>
                        ...
                        {/* Image Section */}
                        <div className="w-full md:w-1/2 flex flex-col md:flex-row gap-4 h-auto md:h-[600px]">
                            {/* Half-height image on left (top on mobile) */}
                            <div className="w-full md:w-1/2 flex flex-col gap-4">
                                <Image
                                    ...
                                    width={500}
                                    height={500}
                                    className="h-[300px] md:h-4/5 w-full object-cover rounded-xl"
                                />
                            ...
                            <div className="w-full md:w-1/2">
                                <Image
                                    ...
                                    width={1000}
                                    height={1250}
                                    className="h-[300px] md:h-full w-full object-cover rounded-xl"
                                />
                            </div>
                        </div>
                    </div>
                ...
                {/* Content Section */}
                <section className="min-h-screen bg-[#010101] relative z-10 py-10 md:py-20">
                    <div className="flex flex-col lg:flex-row justify-between gap-3 md:gap-6 px-4 items-center">
                        {/* Left Image */}
                        <Image
                            ...
                            width={500}
                            height={500}
                            className="w-40 h-40 sm:w-60 sm:h-60 object-cover rounded-xl"
                        />

                        {/* Text Content */}
                        <div className="max-w-4xl w-full px-6 py-16 lg:py-32">
                            <div className="text-background-custom text-base sm:text-lg lg:text-xl leading-relaxed lg:leading-loose space-y-12 relative">

                                {/* Block 1 */}
                                <div className="relative">
                                    <p className="text-xl sm:text-2xl lg:text-3xl font-TiemposHeadlineLight text-center leading-relaxed">
                                        I work with brands going through change—helping them ask the right questions, find clarity, and bring ideas to life through thoughtful design and practical strategy.
                                    </p>
                                    <Image
                                        ...
                                        width={500}
                                        height={500}
                                        className="w-20 sm:w-28 lg:w-32 absolute top-24 -right-6 rotate-45"
                                    />
                                </div>
                                ...
                                <div className="relative">
                                    <p className="text-xl sm:text-2xl lg:text-3xl font-TiemposHeadlineLight text-center leading-relaxed">
                                        I like to keep things open and collaborative. I’ll adapt to your workflow, share ideas early, and stay close to your vision as it grows. It’s less about having all the answers upfront, and more about figuring it out together.
                                    </p>
                                    <Image
                                        ...
                                        width={500}
                                        height={500}
                                        className="w-20 sm:w-28 lg:w-32 absolute -top-28 -left-8 sm:-left-16 rotate-[15deg]"
                                    />
                                </div>
                                ...
                                <div className="relative">
                                    <p className="text-xl sm:text-2xl lg:text-3xl font-TiemposHeadlineLight text-center leading-relaxed">
                                        Whether it’s a small team or a growing business, I’m here to help turn ideas into something real—one clear step at a time.
                                    </p>
                                    <Image
                                        ...
                                        width={500}
                                        height={500}
                                        className="w-16 sm:w-20 absolute -top-12 right-10 sm:right-32"
                                    />
                                </div>
