...
const FallingText: React.FC<FallingTextProps> = ({
    ...
    useEffect(() => {
        ...
        // Configure engine for better performance and to prevent maxUpdates error
        ...
        ]);        // Use custom update loop with throttled physics to prevent maxUpdates error
        let lastTime = 0;
        const targetFPS = 60;
        ...
        const updateLoop = (currentTime: number) => {
            if (currentTime - lastTime >= frameInterval) {
                // Update physics at controlled rate
        ...
        animationId = requestAnimationFrame(updateLoop); return () => {
    ...
    return (<div
        ...
        onKeyDown={trigger === "click" ? (e) => e.key === 'Enter' && handleTrigger() : undefined}
